    ...
    useEffect(() => {
        const fetchLocations = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/hotel-location`, {
                    headers: {
            ...
            <div className="flex-1 p-10 ml-62">
                ...
                <div className="mt-8">
                    <div className="w-full flex justify-between">
                        ...
                        <Link href="/admin/hotel-location/add-hotel-location"
                        ...
                        {locations.length === 0 ? (
                            ...
                            locations.map((location) => (
                                <tr key={location.id}>
                                    ...
                                    <td className="py-4 px-4 border-b border-gray-200">
                                        <Link href={`/admin/hotel-location/view-hotel-location/${location.id}`}
