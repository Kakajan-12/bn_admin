    ...
    useEffect(() => {
        const fetchGallery = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/hotel-gallery`, {
                    headers: {
                ...
                const grouped = response.data.reduce((acc: GroupedGallery[], item: GalleryItem) => {
                    const existing = acc.find(g => g.hotel_id === item.hotel_id);
                    if (existing) {
                        existing.images.push(item);
                    } else {
                        acc.push({
                            hotel_id: item.hotel_id,
                            hotels_title_tk: item.hotels_title_tk,
                            hotels_title_en: item.hotels_title_en,
                            hotels_title_ru: item.hotels_title_ru,
                            images: [item],
                        });
                    }
                    return acc;
            ...
            <div className="flex-1 p-10 ml-62">
                ...
                <div className="mt-8">
                    <div className="w-full flex justify-between items-center">
                        ...
                        <Link
                            href="/admin/hotel-gallery/add-gallery"
                    ...
                    <div className="bg-white rounded shadow divide-y">
                        {gallery.map(group => (
                            <div key={group.hotel_id}>
                                ...
                                >
                                    <div className="font-bold text-2xl" dangerouslySetInnerHTML={{ __html: group.hotels_title_en || 'Untitled' }} />
                                        ...
                                        {group.images.map(img => (
                                            ...
                                            >
                                                ...
                                                <div className="mt-auto">
                                                    <Link
                                                        href={`/admin/hotel-gallery/view-gallery/${img.id}`}
